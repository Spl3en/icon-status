...
def index():
    ...
    servers.append (view.status (model.status ("https://bicon.net.solidwallet.io"), "Testnet for DApps 1"))
    servers.append (view.status (model.status ("https://cicon.net.solidwallet.io"), "Testnet for DApps 2"))
    servers.append (view.status (model.status ("https://dicon.net.solidwallet.io"), "Testnet for DApps 3"))
